...
// perform long polling for captain such that captain request for the new ride and when the new ride is available then send the data
...
subscribeToQueue("new-ride", (data) => {
    ...
    // Sends the ride data to every waiting captain
